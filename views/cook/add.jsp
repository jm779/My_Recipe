	...
	<div class="container my-5" style="max-width: 800px;">
	    ...
	    <form method="post" action="${pageContext.request.contextPath}/cook/add">
	      ...
	      <div class="mb-3">
	        ...
	        <input type="text" name="recipetitle" class="form-control"/>
	      </div>
				...
				<div>	
		          ...
		          <div class="mb-2">
		            ...
		            <div class="d-flex gap-2">
		              ...
		              <button type="button" class="btn btn-outline-primary" onclick="addIngre(this)">+</button>
		            </div>
		          </div>
	      ...
	      <div class="text-end mb-3">
	        <button type="button" class="btn btn-secondary" id="add_step_btn">STEP 추가</button>
	      </div>
