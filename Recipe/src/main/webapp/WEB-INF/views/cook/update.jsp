  ...
  <div class="container my-5" style="max-width: 800px; margin-left: 430px;">
    ...
    <form method="post" action="${pageContext.request.contextPath}/cook/update/${item.recipeid}" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="rcomment" class="form-control" value="${item.rcomment}" />
      </div>
      ...
      <div class="mb-3">
        ...
        <div id="main_img_container" style="width: 500px; height: 300px; background-color: #e0e0e0; margin-bottom: 10px; position: relative; overflow: hidden;">
          ...
          <div class="d-flex" style="width: 110px; height: 35px; position: absolute; top: 10px; left: 10px; background-color: gray; justify-content: center; padding-top: 5px; z-index: 4;">
            <img src="${pageContext.request.contextPath}/resources/image/camera.png" alt="camera_icon" style="width: 20px; height: 20px; margin-top: 2px;">
          ...
          <legend class="fw-bold">요리순서</legend>
	         <c:forEach var="step" items="${steps}" varStatus="status">
		          <div class="step border p-3 mb-3">
		            ...
		            <div class="mb-2">
		              ...
		              <input type="file" name="file[${status.index}]" class="step-file-input" style="display: none;" />
		              <img src="${pageContext.request.contextPath}${step.imagepath}" alt="요리 이미지" style="width: 100%; height: 250px; object-fit: cover;" />
		              <button type="button" class="btn btn-light btn-sm border-0 step-photo-btn">이미지 변경</button>
		            ...
		            <div class="mb-2">
		              ...
		              <div class="ingre_input row gap-2">
		                <input type="text" name="steps[${status.index}].ingredient" class="step-ingredient form-control" value="${step.ingredient}" placeholder="재료" />
		              </div>
		            ...
		            <div class="mb-2">
		              ...
		              <div class="tools_input row gap-2">
		                <input type="text" name="steps[${status.index}].tools" class="step-tools form-control" value="${step.tools}" placeholder="도구" />
		              </div>
		            ...
		            <div class="mb-2">
		              ...
		              <div class="tip_input row gap-2">
		                <input type="text" name="steps[${status.index}].tip" class="step-tip form-control" value="${step.tip}" placeholder="팁" />
		              </div>
	        ...
	        <template id="step-template">
			  <div class="step border p-3 mb-3">
			    ...
			    <input type="text" name="steps[0].content" placeholder="조리내용을 적어보세요!" class="step-content form-control mb-2" />
			    ...
			    <div class="mb-2">
			      <label><strong>재료</strong></label>
			      <div class="ingre_input row gap-2">
			        <input type="text" name="steps[0].ingredient" placeholder="재료" class="step-ingredient form-control" />
			      </div>
			      <button type="button" class="btn btn-outline-primary" id="add_ingre">+</button>
			      <button type="button" class="btn btn-outline-primary" id="delete_ingre">-</button>
			    </div>
			    ...
			    <div class="mb-2">
			      <label><strong>도구</strong></label>
			      <div class="tools_input row gap-2">
			        <input type="text" name="steps[0].tools" placeholder="도구" class="step-tools form-control" />
			      </div>
			      <button type="button" class="btn btn-outline-primary" id="add_tools">+</button>
			      <button type="button" class="btn btn-outline-primary" id="delete_tools">-</button>
			    </div>
			    ...
			    <div class="mb-2">
			      <label><strong>팁</strong></label>
			      <div class="tip_input row gap-2">
			        <input type="text" name="steps[0].tip" placeholder="팁" class="step-tip form-control" />
			      </div>
			      <button type="button" class="btn btn-outline-primary" id="add_tip">+</button>
			      <button type="button" class="btn btn-outline-primary" id="delete_tip">-</button>
			    </div>
