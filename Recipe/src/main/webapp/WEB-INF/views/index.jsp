    ...
    <c:forEach var="item" items="${hotList}">
      <div class="col">
        <div class="card h-100 shadow-sm">
          <img src="${pageContext.request.contextPath}/resources/image/${item.mainimagepath}" class="card-img-top" alt="${item.title}" style="height:200px; object-fit:cover;">
          <div class="card-body">
  ...
  <table class="table table-bordered table-hover text-center">
    ...
    <tbody>
      <c:forEach var="n" items="${noticeList}">
        <tr>
          <td class="text-start">${n.noticeid}</td>
          <td>${n.noticename}</td>
          <td>${n.writer}</td>
          <td>${n.date}</td>
        </tr>
